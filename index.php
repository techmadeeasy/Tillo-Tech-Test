            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <dl>
                  ...
                  <dd class="mt-1 text-3xl leading-9 font-semibold text-gray-900">
                        <?php echo formatMoney(array_sum(array_column($decoratedOrders->gbpOrdersWithMinAmount(), 'price'))) ?>
                  </dd>
                </dl>
              </div>
            </div>
            <div class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <dl>
                  ...
                  <dd class="mt-1 text-3xl leading-9 font-semibold text-gray-900">
                        <?php echo formatMoney(array_sum(array_column($decoratedOrders->paidInGBP(), 'price'))) ?>
                  </dd>
                </dl>
              </div>
            </div>
            <div class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <dl>
                  ...
                  <dd class="mt-1 text-3xl leading-9 font-semibold text-gray-900">
                        <?php echo formatMoney(array_sum(array_column($decoratedOrders->gbpOrdersShippedToEssex(), 'price'))) ?>
                  </dd>
                </dl>
              </div>
            </div>
